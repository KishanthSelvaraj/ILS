  ...
  return (
    <>
      ...
      <div className="bg-white py-10 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="animated mx-auto max-w-2xl lg:text-center">
            <h2 className=" text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl text-center">
              What we do
            </h2>
      ...
      <div className="bg-white px-4 pb-4">
        <div className="animated mx-auto max-w-2xl lg:text-center">
          <p className="mt-2 text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl text-center">
            Our Approach
          </p>
