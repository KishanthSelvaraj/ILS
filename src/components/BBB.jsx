  ...
  return (
    <div className="">
      <ul className="list-disc">
        ...
        <li>
          <span className="text-gray-700 font-semibold">
            ILS fosters a culture of innovation and creativity within the
            organization, encouraging employees to think outside the box,
            experiment with new ideas, and develop innovative solutions to
            complex challenges.
          </span>
        </li>
        <li>
          <span className="text-gray-700 font-semibold">
            ILS assists organizations in aligning their internal systems,
            processes, and skills with their strategic objectives, ensuring that
            every aspect of the business contributes to its overall goals and
            mission.
          </span>
        </li>
      </ul>
