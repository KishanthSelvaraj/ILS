...
import ilsLogo from "/ILS_logo.png";

const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-gray-100   pb-0 pt-20   overflow-x-hidden ">
        <div className="">
          <div className=" flex flex-wrap ">
            <div className="w-full sm:w-2/3 lg:w-3/12 px-9">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-2 inline-block max-w-[160px]">
                  <img
                    src="https://www.theleanway.com/wp-content/themes/ils/images/logo.png"
                    alt="logo"
                    className="w w-28 "
                  />
                </a>
                <p className=" text-md">
                Enterprise Performance Improvement – The Lean Way
                </p>
              </div>
            </div>
            ...
            {/* <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full ml-3">
        ...
        <div>
          ...
          <div className="bg-[#111928] text-white text-sm text-center py-1">
            Copyright © 2024 ILS | All rights reserved.
          </div>
        </div>
      </footer>
    </>
